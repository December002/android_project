    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendBtn.setOnClickListener(view->{
            ...
            Util.sendGetRequest(0,
                    "http://192.168.0.28:9000/boot07/android/tweet",
                    map,
                    this);
        });
        //두번째 버튼도 리스너 등록하기
        ...
        sendBtn2.setOnClickListener(view->{
            ...
            Util.sendPostRequest(1,
                    "http://192.168.0.28:9000/boot07/android/tweet2",
                    map,
                    this);
        });
        //세번째 버튼도 리스너 등록하기
        ...
        sendBtn3.setOnClickListener(view->{
            ...
            Util.sendGetRequest(2,
                    "http://192.168.0.28:9000/boot07/android/tweet3",
                    map,
                    this);
        });
        ...
        listBtn.setOnClickListener(view->{
            Util.sendGetRequest(3,
                    "http://192.168.0.28:9000/boot07/android/list",
                    null,
                    this);
        });
    }
